...
// Instantiation of Axi Bus Interface S00_AXI
	axi_pwm_buckboost_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) axi_pwm_buckboost_v1_0_S00_AXI_inst (
        ...
        .S_AXI_PWM_MODE(pwm_mode),
        .S_AXI_PWM_SW_HS(sw_hs),
        .S_AXI_PWM_SW_LS(sw_ls)
	);
	...
	assign sw_1 = (pwm_mode == 1) ? sw_hs : pwm_a;
	assign sw_2 = (pwm_mode == 1) ? sw_ls : pwm_b;

	assign sw_3 = (pwm_mode == 0) ? sw_hs : pwm_b;
	assign sw_4 = (pwm_mode == 0) ? sw_ls : pwm_a;
